...
#ax.plot_surface(lon2, lat2,hig, rstride=1, cstride=1, cmap=cmaps)
color_map =data.reshape(43*49)
print(color_map.shape)
ax.scatter(lon2, lat2,hig,c=color_map,cmap=cmaps, s=5,label='Points')
# ax.scatter(lon2, lat2,hig,cmap='jet', s=40,
#              label='Points')
# ax.contourf(lon,lat,data,zdir='z',offset=-2)
ax.contourf(lon,lat,data,cmap=cmaps,zdir='z',offset=-15)
